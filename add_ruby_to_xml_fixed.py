...
def main():
    """Main function"""
    input_file = "questions-ビジネス・キャリア検定試験-Default for 令和5年前期 (copy) (copy)-20250714-0031.xml"
    output_file = "questions-ビジネス・キャリア検定試験-Default for 令和5年前期 (copy) (copy)-20250714-0031_ruby_fixed.xml"
